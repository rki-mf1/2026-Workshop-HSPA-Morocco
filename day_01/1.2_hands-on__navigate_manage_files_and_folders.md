...
```bash
# List the content 
ls ~/2026-Workshop-HSPA-Morocco

# List the content of another directory
ls ~/2026-Workshop-HSPA-Morocco/data

# Go to data using either relative or absolute path

# Go to /home using a relative path

# Go to 2026-Workshop-HSPA-Morocco using an absolute path
...
# Navigate to 2026-Workshop-HSPA-Morocco
