...
```bash
# Go to 2026-Workshop-HSPA-Morocco/day_01

# Copy the file ERR10453087.fastq.gz from 2026-Workshop-HSPA-Morocco/data to here
...
Before you try out Nano to open a file, make yourself familiar with the necessary _shortcuts_:
...
```bash
# Navigate to 2026-Workshop-HSPA-Morocco/day_01
